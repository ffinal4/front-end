...
const ChattingPage = () => {
    ...
    const [messageList, setMessageList] = useState([
        {profile: NonPofile, name: "이승재", message: "TEAM 핍포 화이팅!", image: Image2, myChat: "", isOpen: false, count: 2},
        ...
        {profile: Profile2, name: "윤지숙", message: "디자이너 화이팅!", image: Image, myChat: "", isOpen: false, count: 1},
        {profile: Profile, name: "이지원A", message: "프론트엔드 화이팅!", image: Image2, myChat: "", isOpen: false, count: 5},
        {profile: Profile2, name: "이지원B", message: "백엔드 화이팅!", image: Image, myChat: "", isOpen: false, count: 4},
        {profile: Profile, name: "김지훈", message: "프로젝트 화이팅!", image: Image2, myChat: "", isOpen: false, count: 7},
    ]);
